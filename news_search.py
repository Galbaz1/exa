...
USER_QUESTION = "What's the recent news about wars or weapon conflicts this week in US media?"
...
SYSTEM_MESSAGE = "You are a helpful assistant that briefly summarizes each article on a webpage that fits the search description. Summarize the users input."
